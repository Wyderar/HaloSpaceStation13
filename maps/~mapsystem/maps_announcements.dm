...
/datum/map/proc/meteors_detected_announcement()
	command_announcement.Announce(replacetext_char(meteor_detected_message, "%STATION_NAME%", station_name()), "[station_name()] Sensor Array", new_sound = meteor_detected_sound)
